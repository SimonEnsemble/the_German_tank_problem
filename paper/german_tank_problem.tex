...
Conceptually, we may think of $\pi_a$ as a water level that we raise to submerge low-probability tank population sizes.
...
Eg., under $n_\text{max} =75$, the high-mass subset $\mathcal{H}_{0.2}$ expands to $\{15, ..., 29\}$.
...
The median of the median of the posterior matches the true tank population size of 20 when $n_{\text{max}}=25$ or $k=9$. For $k\in\{3, 6\}$, the larger $n_{\text{max}}$ pull the median to the right of the true tank population size.
  ...
  \begin{figure}[h!]
            ...
            Columns: different maximum tank population size entertained in the uniform prior, $n_{\text{max}}$ (top). 
