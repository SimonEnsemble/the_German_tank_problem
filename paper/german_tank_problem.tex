...
Assuming (i) all tanks in the population were equally likely to be captured and (ii) $n$ is fixed over the time scale of capturing tanks, our objective is to estimate $n$ in light of the data \data.
