...
The Bayesian probability theory to solve the German tank problem applies to other contexts, where, instead of tanks, we wish to estimate eg.: the number of taxicabs in a city \cite{grajalez2013great}, the number of accounts at a bank \cite{hohle2006bayesian}, the number of furniture pieces purchased by a university \cite{goodman1954some}, the number of aircraft operations at an airport \cite{mott2016estimation}, the extent of leaked classified government communications \cite{gill2015estimating}, the time needed to complete a project deadline \cite{fehlmann2017new}, the time-coverage of historical records of extreme events like floods \cite{prosdocimi2018german}, and generally, the maximum in a large data set \cite{gum2005estimating}. 
%\end{itemize}
%\begin{itemize}
